...
log using log/rostock-lecture-use-mutz-to-explain-fe-models.log, replace

********************************************************************************
*** This file is deprecated.  It is the vestige of the original file that 
***  generated the models for the July 2, 2018 Rostock lecture.  It has been
***  tidied up and replaced by the November 2018 file 
***  use-mutz-to-explain-fe-models.do and then 
...
*** BEGIN ***********************************************************************
*** CHUNK for PNAS LETTER *** CHUNK for PNAS LETTER *** CHUNK for PNAS LETTER **
*** CHUNK for PNAS LETTER *** CHUNK for PNAS LETTER *** CHUNK for PNAS LETTER **
*** CHUNK for PNAS LETTER *** CHUNK for PNAS LETTER *** CHUNK for PNAS LETTER **
*** CHUNK for PNAS LETTER *** CHUNK for PNAS LETTER *** CHUNK for PNAS LETTER **
...
/* Changed below to add PNAS letter model */
