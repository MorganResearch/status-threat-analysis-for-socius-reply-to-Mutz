...
log using log/mutz-code-panel-edited-v1.log, replace
...
* drop from merged data because recreated with this code
...
/*  NOTE:  Toggle this section to reshape and calculate some results	
...
quietly logit demrepvote xparty3 income lookingforwork personeco tradeper ///
    tradeself proimmself chinaself ///
 	...
 	pretradediffdemwave  preimmdiffdemwave prechinadiffdemwave ///
 	pretradediffrepwave  preimmdiffrepwave prechinadiffrepwave ///
 	presdowave preeconomywave  /* acsunemplwave=0  acsmfgwave=0 acsincomewave=0 */ ///
    wave, cluster(MNO) 
