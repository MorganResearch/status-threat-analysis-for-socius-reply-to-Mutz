...
***Please note that zip codes and zip code-based variables included in ***
***the publication are not included in the panel data set due to data privacy ***
***agreement with NORC. Those variables should be deleted from the models ***
*** below if running new models***
